...
public class AutonomousDropCtrBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        driveEncoders(0.5, 0.5, 88); //one foam tile hypoteneuse is sqrt(24^2 + 24^2) inches and then 4 back so bot can turn. backwards for dropper. Changed from 87.8
        turn(LEFT,45); //parralel w beacon right while backwards is left
        driveEncoders(0.5,0.5,19); //front wheel 1 ft 4 in from center of beacon, climber aligned w back wheel. Changed from 14.4
        dropClimbers();
